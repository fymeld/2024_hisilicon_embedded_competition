...
int color[80] = {0xFFFFFF,0xF0FFFF,0xCCCCCC,0xFAFFF0,0xFAF0E6,0xFFFFCD,0xFFF5EE,0xFFFF00,
                 0xFF9912,0xE3CF57,0xFFD700,0xFF7D40,0xFFE384,0xFF8000,0xED9121,0x8B864E,
                 0x802A2A,0xC76114,0xF4A460,0xD2B48C,0xBC8F8F,0xA0522D,0xC76114,0xA020F0,
                 0xDA70D6,0x8A2BE2,0x9933FA,0x00C78C,0x191970,0x03A89E,0x0000FF,0x6B8E23,
                 0x228B22,0x082E54,0x40E0D0,0x7FFF00,0x00FFFF,0x00FF00,0x990033,0xFF00FF,
                 0xB0171F,0xFFC0CB,0xFF6347,0xFF7F50,0x9C661F,0xE3170D,0xFF0000,0xFCE6C9,
                 0xF5F5F5,0xE6E6E6,0x808069,0x808A87,0x666666,0x000000,0x231343,0xacdeda,
                 0x235443,0x243552,0xefcdad,0x1259dd,0x9abcae,0xbdacef,0x246adf,0x25abce,
                 0xffdeab,0x25acff,0x54fdff,0xffeecc,0x99aacc,0x138cda,0x46ffee,0x5623ff,
                 0xeeccaa,0x6daec7,0x54def0,0x45190a,0x45735d,0x9385ab,0x394aaf,0xd90a23};
...
HI_S32 YOLOV5ObjectDetectCal(VIDEO_FRAME_INFO_S *srcFrm, VIDEO_FRAME_INFO_S *dstFrm)
{
    HI_S32 resLen = 0;
    int objNum;
    int ret;
    ...
    //MppFrmDrawRects(dstFrm, boxs, objNum, RGB888_GREEN, DRAW_RETC_THICK);
    for(int j=0;j<objNum;j++){
        objBoxs[0] = boxs[j];
        MppFrmDrawRects(dstFrm, objBoxs, 1, color[objs[j].cls], DRAW_RETC_THICK);
    }
